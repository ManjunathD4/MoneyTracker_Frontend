                ...
                <div className="my-5 mx-auto">
                        ...
                        <form action="" className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-6 gap-4">
                            ...
                            <div className="sm:col-span-1 md:col-span-1 flex items-end">
                                <div className="w-full">
                                    ...
                                    <input value={keyword} type="keyword" placeholder="Search..." className="w-full border rounded px-3 py-2" onChange={e=>setKeyword(e.target.value)} />
                                </div>
                    ...
                    <div className="card p-4">
                        ...
                        {transaction.length===0 && !loading?(
                            <p className="text-gray-500">Select the filetrs and click apply to filter the transaction</p>
                        ):("")}
                        {transaction.map((trans)=>(
                            <TransactionInfoCard 
                                ...
                                title={trans.name}
                                icon={trans.icon}
                                date={moment(trans.data).format('Do MMM YYYY')}
                                amount={trans.amount}
                                type={type}
                                hideDeletebtn
