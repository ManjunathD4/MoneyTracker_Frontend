...
const Sidebar = ({activeMenu}) =>{
    ...
    return(
       <div className="w-64 h-[cal(100vh-61px)] bg-white border-gray-200/50 p-5 sticky top-[61px] z-20">
        <div className="flex flex-col items-center justify-center gap-3 mt-3 mb-7">
            {user?.profileImageUrl ?(
                <img src={user?.profileImageUrl|| ""} alt="Profile image" className="w-20 h-20 bg-slate-400 round-full"/>
            ):(
