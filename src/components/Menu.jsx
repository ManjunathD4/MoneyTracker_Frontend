...
const Menubar=({activeMenu}) =>{
    ...
    return(
       <div className="flex items-center justify-between gap-5 bg-white border border-b border-gray-200/5 backdrop-blur-[2px] py-4 px-4 smpx-7 sticky top-0 z-30">
        {/* {Left side-menu} */}
        <div className="flex item-center gap-5">
            <button 
                onClick={() => setOpenSideMenu(!openSideMenu)}
                className="block lg:hidden text-black hover:bg-gray-100 p1 rounded transition-colors">
                {openSideMenu?(
